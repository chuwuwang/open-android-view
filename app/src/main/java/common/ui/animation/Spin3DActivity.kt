...
class Spin3DActivity : AppCompatActivity() {

    private val binding: ActivityAnimation3dSpinBinding by lazy { ActivityAnimation3dSpinBinding.inflate(layoutInflater) }
    ...
    inner class PagerAdapter : RecyclerView.Adapter<PagerAdapter.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: PagerAdapter.ViewHolder, position: Int) {
            when (position) {
                ...
                3 -> {
                    holder.pic.setImageResource(R.drawable.achievement_wanchengdu2l)
